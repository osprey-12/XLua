...
void xlua_cmd_install_handler(xlua_cmd * cmd, xlua_cmd_handler_f handler, notify_cb_t* ref)
{
...
void xlua_cmd_install_filter(xlua_cmd* cmd, xlua_cmd_handler_f handler, notify_cb_t* ref)
{
	if (cmd->m_filter_handler != nullptr)
	{
		printf("ERROR: there is already a filter handler installed: %s.\n", cmd->m_name.c_str());
		return;
	}
...
void xlua_cmd_install_pre_wrapper(xlua_cmd * cmd, xlua_cmd_handler_f handler, notify_cb_t* ref)
{
...
void xlua_cmd_install_post_wrapper(xlua_cmd * cmd, xlua_cmd_handler_f handler, notify_cb_t* ref)
{
